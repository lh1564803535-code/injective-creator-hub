  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <ScrollRevealSection className="px-6 pb-16 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="mb-10 text-center">
            <h2 className="text-2xl font-bold text-white">{t('whyChoose')}</h2>
            <p className="mt-2 text-sm text-gray-500">
              {t('whyChooseDesc')}
            </p>
          </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-6 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-400">{t('submissions')}:</span>
                        <span className="font-semibold text-white">
      ...
      <ScrollRevealSection delay={2} className="px-6 pb-12 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-6 flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-white">{t('topCreators')}</h2>
              <p className="text-sm text-gray-500">{t('topCreatorsDesc')}</p>
            </div>
            <Link
              href="/leaderboard"
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-2 flex gap-3 text-xs text-gray-500">
                    <span>{creator.totalVotes} {t('votes')}</span>
      ...
      <ScrollRevealSection delay={1} className="px-6 pb-12 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">{t('recentActivityDesc')}</p>
          </div>
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm text-gray-200">
                      ...
                      <span className="text-gray-500">
                        {activity.type === "submission" && t('submittedTo')}
                        {activity.type === "vote" && t('votedIn')}
                        {activity.type === "settle" && t('settled')}
                        {activity.type === "claim" && t('claimedFrom')}
                      </span>{" "}
                      <Link
      ...
      <ScrollRevealSection className="px-6 pb-16 lg:px-8">
        <div className="mx-auto max-w-3xl">
          <div className="mb-10 text-center">
            <h2 className="text-2xl font-bold text-white">{t('roadmap')}</h2>
            <p className="mt-2 text-sm text-gray-500">
              {t('roadmapDesc')}
            </p>
          </div>
