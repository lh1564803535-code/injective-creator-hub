...
import { Star, ThumbsUp, Send, User, Megaphone } from "lucide-react";
...
interface CampaignReviewProps {
  reviews?: CampaignReviewItem[];
  campaignName?: string;
  onSubmit?: (content: string, rating: number, type: "campaign" | "submission") => void;
...
export function CampaignReview({
  ...
  const [reviewType, setReviewType] = useState<"campaign" | "submission">("campaign");
  ...
  // Sort: campaign reviews first, then by date desc
      ...
      <div className="flex items-center justify-between border-b border-white/[0.06] px-5 py-3.5">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold text-white">
            {campaignName ? `${campaignName} Reviews` : "Campaign Reviews"}
          </span>
        ...
        <div className="border-b border-white/[0.06] bg-white/[0.02] p-4 space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex gap-2">
              <button
                onClick={() => setReviewType("campaign")}
